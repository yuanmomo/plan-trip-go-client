...
// checks if the VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel{}

// VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel Information about a line.
type VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel struct {
	// The line name.
...
func NewVTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel() *VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel {
	this := VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel{}
	return &this
}
...
func (o *VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel) SetBackgroundColorNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel) SetForegroundColorNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel) SetBorderColorNil() {
...
func (o VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel) MarshalJSON() ([]byte, error) {
...
func (o VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel) ToMap() (map[string]interface{}, error) {
...
type NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel struct {
	value *VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel
	isSet bool
}

func (v NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel) Get() *VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel {
	return v.value
}

func (v *NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel) Set(val *VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel) {
	v.value = val
	v.isSet = true
}

func (v NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel) IsSet() bool {
	return v.isSet
}

func (v *NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel(val *VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel) *NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel {
	return &NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel{value: val, isSet: true}
}

func (v NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
