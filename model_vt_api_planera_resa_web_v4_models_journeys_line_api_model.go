...
// checks if the VTApiPlaneraResaWebV4ModelsJourneysLineApiModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VTApiPlaneraResaWebV4ModelsJourneysLineApiModel{}

// VTApiPlaneraResaWebV4ModelsJourneysLineApiModel Information about a line.
type VTApiPlaneraResaWebV4ModelsJourneysLineApiModel struct {
	// The line name.
...
func NewVTApiPlaneraResaWebV4ModelsJourneysLineApiModel() *VTApiPlaneraResaWebV4ModelsJourneysLineApiModel {
	this := VTApiPlaneraResaWebV4ModelsJourneysLineApiModel{}
	return &this
}
...
func (o *VTApiPlaneraResaWebV4ModelsJourneysLineApiModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *VTApiPlaneraResaWebV4ModelsJourneysLineApiModel) SetBackgroundColorNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneysLineApiModel) SetForegroundColorNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneysLineApiModel) SetBorderColorNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneysLineApiModel) SetShortNameNil() {
	o.ShortName.Set(nil)
}
...
func (o *VTApiPlaneraResaWebV4ModelsJourneysLineApiModel) SetDesignationNil() {
...
func (o VTApiPlaneraResaWebV4ModelsJourneysLineApiModel) MarshalJSON() ([]byte, error) {
...
func (o VTApiPlaneraResaWebV4ModelsJourneysLineApiModel) ToMap() (map[string]interface{}, error) {
...
type NullableVTApiPlaneraResaWebV4ModelsJourneysLineApiModel struct {
	value *VTApiPlaneraResaWebV4ModelsJourneysLineApiModel
	isSet bool
}

func (v NullableVTApiPlaneraResaWebV4ModelsJourneysLineApiModel) Get() *VTApiPlaneraResaWebV4ModelsJourneysLineApiModel {
	return v.value
}

func (v *NullableVTApiPlaneraResaWebV4ModelsJourneysLineApiModel) Set(val *VTApiPlaneraResaWebV4ModelsJourneysLineApiModel) {
	v.value = val
	v.isSet = true
}

func (v NullableVTApiPlaneraResaWebV4ModelsJourneysLineApiModel) IsSet() bool {
	return v.isSet
}

func (v *NullableVTApiPlaneraResaWebV4ModelsJourneysLineApiModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVTApiPlaneraResaWebV4ModelsJourneysLineApiModel(val *VTApiPlaneraResaWebV4ModelsJourneysLineApiModel) *NullableVTApiPlaneraResaWebV4ModelsJourneysLineApiModel {
	return &NullableVTApiPlaneraResaWebV4ModelsJourneysLineApiModel{value: val, isSet: true}
}

func (v NullableVTApiPlaneraResaWebV4ModelsJourneysLineApiModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVTApiPlaneraResaWebV4ModelsJourneysLineApiModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
