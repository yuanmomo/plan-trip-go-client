...
// checks if the VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel{}

// VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel Information about a walk, bike or car link from origin to first public transport trip leg.
type VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel struct {
...
func NewVTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel() *VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel {
	this := VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel{}
	return &this
}
...
func (o *VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) SetDistanceInMetersNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) SetPlannedDepartureTimeNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) SetPlannedArrivalTimeNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) SetPlannedDurationInMinutesNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) SetEstimatedDepartureTimeNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) SetEstimatedArrivalTimeNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) SetEstimatedDurationInMinutesNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) SetEstimatedNumberOfStepsNil() {
...
func (o VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) MarshalJSON() ([]byte, error) {
...
func (o VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) ToMap() (map[string]interface{}, error) {
...
type NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel struct {
	value *VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel
	isSet bool
}

func (v NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) Get() *VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel {
	return v.value
}

func (v *NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) Set(val *VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) {
	v.value = val
	v.isSet = true
}

func (v NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) IsSet() bool {
	return v.isSet
}

func (v *NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel(val *VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) *NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel {
	return &NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel{value: val, isSet: true}
}

func (v NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
