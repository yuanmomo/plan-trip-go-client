...
// checks if the VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse{}

// VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse The response to a get arrivals request, includes the results and pagination information.
type VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse struct {
	// The results.
	Results []VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsArrivalApiModel `json:"results,omitempty"`
...
func NewVTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse() *VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse {
	this := VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse{}
	return &this
}
...
func (o *VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse) GetResults() []VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsArrivalApiModel {
	if o == nil {
		var ret []VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsArrivalApiModel
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsArrivalApiModel and assigns it to the Results field.
...
func (o VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse) MarshalJSON() ([]byte, error) {
...
func (o VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableVTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse struct {
	value *VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse
	isSet bool
}

func (v NullableVTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse) Get() *VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse {
	return v.value
}

func (v *NullableVTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse) Set(val *VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse(val *VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse) *NullableVTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse {
	return &NullableVTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse{value: val, isSet: true}
}

func (v NullableVTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsGetArrivalsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
