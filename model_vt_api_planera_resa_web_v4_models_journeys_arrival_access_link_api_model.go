...
// checks if the VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel{}

// VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel Information about a walk, bike or car link from last public transport trip leg to destination.
type VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel struct {
...
func NewVTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel() *VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel {
	this := VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel{}
	return &this
}
...
func (o *VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) SetDistanceInMetersNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) SetPlannedDepartureTimeNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) SetPlannedArrivalTimeNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) SetPlannedDurationInMinutesNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) SetEstimatedDepartureTimeNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) SetEstimatedArrivalTimeNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) SetEstimatedDurationInMinutesNil() {
...
func (o *VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) SetEstimatedNumberOfStepsNil() {
...
func (o VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) MarshalJSON() ([]byte, error) {
...
func (o VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) ToMap() (map[string]interface{}, error) {
...
type NullableVTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel struct {
	value *VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel
	isSet bool
}

func (v NullableVTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) Get() *VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel {
	return v.value
}

func (v *NullableVTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) Set(val *VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) {
	v.value = val
	v.isSet = true
}

func (v NullableVTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) IsSet() bool {
	return v.isSet
}

func (v *NullableVTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel(val *VTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) *NullableVTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel {
	return &NullableVTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel{value: val, isSet: true}
}

func (v NullableVTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVTApiPlaneraResaWebV4ModelsJourneysArrivalAccessLinkApiModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
